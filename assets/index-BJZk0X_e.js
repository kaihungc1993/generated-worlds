...
void main() {
	...
	`}var Vs=class extends Zt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new aa(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function tf(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var nf=class extends Ln{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new ua;e.deleteAttribute(`uv`);let t=new Ma({side:1}),n=new Ma,r=new jo(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new ri(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new ki(e,n,6),o=new Dn;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new ri(e,rf(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new ri(e,rf(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new ri(e,rf(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new ri(e,rf(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new ri(e,rf(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new ri(e,rf(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function rf(e){return new Pa({color:0,emissive:16777215,emissiveIntensity:e})}var af=class{constructor(e,{onReady:t,onError:n,onTime:r}={}){this.container=e,this.onReady=t??(()=>{}),this.onError=n??(()=>{}),this.onTime=r??(()=>{}),this.disposed=!1,this.playing=!0,this.duration=0,this.renderer=new Tu({antialias:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.1,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,e.appendChild(this.renderer.domElement),this.scene=new Ln,this.scene.background=of(),this.camera=new Do(45,1,.05,2e3),this.controls=new Fu(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.07,this.controls.autoRotate=!0,this.controls.autoRotateSpeed=1.1,this.controls.addEventListener(`start`,()=>this.controls.autoRotate=!1);let i=new Ms(this.renderer);this.scene.environment=i.fromScene(new nf,.04).texture,this.scene.environmentIntensity=.85,i.dispose();let a=new Po(16774374,1.6);a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.bias=-3e-4,a.shadow.normalBias=.02,this.keyLight=a,this.scene.add(a);let o=new Po(12374271,.7);this.rimLight=o,this.scene.add(o);let s=new ef().setDecoderPath(`./draco/`);this.loader=new Zu().setDRACOLoader(s),this.clock=new as,this.mixer=null,this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(e),this.resize(),this.renderer.setAnimationLoop(()=>this.tick())}async load(e,{environment:t=!1,hideCeilings:n=!1,skyUrl:r=null,loopPingPong:i=!1,thumbFrame:a=0,fpCamera:o=null}={}){try{let s=r?new po().loadAsync(r).catch(e=>(console.warn(`sky load failed`,e),null)):Promise.resolve(null),[c,l]=await Promise.all([this.loader.loadAsync(`./`+e),s]);if(this.disposed){l?.dispose();return}l&&(l.mapping=303,l.colorSpace=We,this.scene.background?.dispose?.(),this.scene.environment?.dispose?.(),this.scene.background=l,this.scene.environment=l,this.scene.environmentIntensity=1);let u=c.scene,d=[];u.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material?.map&&(e.material.map.anisotropy=8)),e.isLight&&d.push(e)}),n&&u.traverse(e=>{/(^|[\s_-])(ceil(ing)?|roof)([\s_-]|$)/i.test(e.name)&&(e.visible=!1)});let f=new Qn().setFromObject(u),p=f.getCenter(new G),m=f.getSize(new G),h=Math.max(m.x,m.y,m.z);u.position.sub(p),u.position.y+=m.y/2-(t?m.y*.06:0),this.scene.add(u),this.object=u,this.keyLight.position.set(h*1.2,h*1.8,h*1.1);let g=h*1.2;if(Object.assign(this.keyLight.shadow.camera,{left:-g,right:g,top:g,bottom:-g,near:.1,far:h*6}),this.keyLight.shadow.camera.updateProjectionMatrix(),this.rimLight.position.set(-h,h*.9,-h*1.3),d.length&&this.adoptImportedLights(d,h,!!l),!t){let e=new ri(new da(h*2.4,64).rotateX(-Math.PI/2),new xa({opacity:.32}));e.receiveShadow=!0,this.scene.add(e);let t=new ri(new da(h*2.4,64).rotateX(-Math.PI/2),new Ma({color:1316383,roughness:.95,metalness:0}));t.position.y=-.002*h,t.receiveShadow=!0,this.scene.add(t)}let _=t?h*.95:h*1.55,v=t?.85:.5;if(t&&a&&(_=h*.55*a,v=.62),this.controls.target.set(0,m.y*(t?.1:.45),0),this.camera.position.set(_*.72,_*v,_*.78),this.camera.near=Math.max(.02,h/500),this.camera.far=h*30,this.camera.updateProjectionMatrix(),this.controls.minDistance=h*.25,this.controls.maxDistance=h*4.5,this.controls.maxPolarAngle=Math.PI*(t?.55:.62),this.controls.update(),t&&(this.controls.autoRotateSpeed=.5,l||(this.scene.fog=new In(1119002,h*2.2,h*9))),o){let e=new G(...o.position).add(u.position),t=jt.degToRad(o.yaw),n=jt.degToRad(o.pitch),r=new G(Math.sin(t)*Math.cos(n),Math.sin(n),-Math.cos(t)*Math.cos(n));this.camera.position.copy(e),this.controls.target.copy(e).addScaledVector(r,Math.max(h*.2,5)),this.camera.fov=o.fov,this.camera.near=Math.max(.05,h/2e3),this.camera.updateProjectionMatrix(),this.controls.autoRotate=!1,this.controls.minDistance=.1,this.controls.maxPolarAngle=Math.PI,this.controls.update()}if(c.animations.length){this.pingPong=i,this.mixer=new is(u);for(let e of c.animations){this.duration=Math.max(this.duration,e.duration);let t=this.mixer.clipAction(e);i&&t.setLoop(Ie,1/0),t.play()}}this.onReady({animated:c.animations.length>0,duration:this.duration})}catch(e){console.error(e),this.onError(e)}}adoptImportedLights(e,t,n){let r=n?1.8:2.2,i=e.filter(e=>e.isDirectionalLight),a=e.filter(e=>!e.isDirectionalLight);a.sort((e,t)=>t.intensity-e.intensity);for(let e of a.slice(24))e.visible=!1;a=a.slice(0,24);let o=Math.max(...i.map(e=>e.intensity),0);if(o>r)for(let e of i)e.intensity*=r/o;let s=Math.max(...a.map(e=>e.intensity),0);if(s>24)for(let e of a)e.intensity*=24/s;for(let t of e)t.castShadow=!1;let c=i.sort((e,t)=>t.intensity-e.intensity)[0];if(c){this.keyLight.castShadow=!1,c.castShadow=!0,c.shadow.mapSize.set(2048,2048),c.shadow.bias=-3e-4,c.shadow.normalBias=.02;let e=t*1.2;Object.assign(c.shadow.camera,{left:-e,right:e,top:e,bottom:-e,near:.1,far:t*6}),c.shadow.camera.updateProjectionMatrix()}this.keyLight.intensity=n?.35:.55,this.rimLight.intensity=.2,this.scene.environmentIntensity=n?.6:.5}setPlaying(e){this.playing=e}seek(e){this.mixer&&this.mixer.setTime(e)}get time(){if(!this.mixer)return 0;let e=Math.max(this.duration,1e-6);if(!this.pingPong)return this.mixer.time%e;let t=this.mixer.time%(2*e);return t>e?2*e-t:t}tick(){if(this.disposed)return;let e=this.clock.getDelta();this.mixer&&this.playing&&(this.mixer.update(e),this.onTime(this.time,this.duration)),this.controls.update(),this.renderer.render(this.scene,this.camera)}resize(){let e=this.container.clientWidth||1,t=this.container.clientHeight||1;this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}dispose(){this.disposed=!0,this.renderer.setAnimationLoop(null),this.resizeObserver.disconnect(),this.scene.traverse(e=>{e.geometry?.dispose?.();let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)if(e){for(let t of Object.values(e))t?.isTexture&&t.dispose();e.dispose?.()}}),this.scene.background?.dispose?.(),this.scene.environment?.dispose?.(),this.renderer.dispose(),this.renderer.domElement.remove()}};function of(){let e=document.createElement(`canvas`);e.width=4,e.height=512;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,512);n.addColorStop(0,`#1b1e2b`),n.addColorStop(.55,`#12141c`),n.addColorStop(1,`#0a0b10`),t.fillStyle=n,t.fillRect(0,0,4,512);let r=new oa(e);return r.colorSpace=We,r}var sf=`./`,cf={assets:{label:`Articulated Assets`,short:`ASSET`,color:`#ff5c5c`,kind:`asset`},sim:{label:`Greybox Scenes`,short:`GREYBOX`,color:`#8ef0c0`,kind:`scene`},worlds:{label:`Generated Worlds`,short:`WORLD`,color:`#7c9eff`,kind:`scene`},game:{label:`Playable Game`,short:`GAME`,color:`#ffd75e`,kind:`game`}},lf=[`theme-park`,`water-park`,`theme-park-ride-system`,`supermarket-interior`,`shopping-mall-interior`,`robotic-arm-assembly-cell`,`dockyard`,`bathhouse`];function uf(e){let t=e.replace(/^Generate (a|an) /i,``).replace(/^Create a scene for [^:]*:\s*/i,``).replace(/^A /i,``);t=t.charAt(0).toUpperCase()+t.slice(1);let n=t.search(/[;.]/);return n>0&&(t=t.slice(0,n)),t.length>120&&(t=t.slice(0,117).replace(/\s+\S*$/,``)+`…`),t}function df(e,t){let n=Object.fromEntries(e.map(e=>[e.slug,e])),r=[];for(let t of e.filter(e=>e.group===`objects`))r.push({id:t.slug,cat:`assets`,kind:`asset`,title:t.title,desc:uf(t.prompt),thumb:sf+t.thumbnail,glb:sf+t.url,sky:null,animated:t.animated,loopPingPong:!!t.loopPingPong,polys:t.polys,sizeKB:t.sizeKB});for(let e of lf){let t=n[e];t&&r.push({id:e,cat:`sim`,kind:`scene`,title:t.title,desc:uf(t.prompt),thumb:sf+t.thumbnail,glb:sf+t.url,sky:t.sky?sf+t.sky:null,animated:t.animated,polys:t.polys,sizeKB:t.sizeKB})}for(let e of t)r.push({id:e.slug,cat:`worlds`,kind:`scene`,title:e.title,desc:uf(e.prompt),thumb:sf+e.thumbnail,glb:sf+e.url,sky:e.sky?sf+e.sky:null,animated:!1,polys:e.polys,sizeKB:e.sizeKB});return r.push({id:`ghost-game`,cat:`game`,kind:`game`,title:`Ghosts in the Dataset`,desc:`A complete cyberpunk arcade world built in Godot 4 — playable right now in your browser.`,thumb:`./play/ghost/promo/street.webp`,glb:null,sky:null,playUrl:`./play/ghost/index.html`,animated:!1,polys:0,sizeKB:0}),r}var ff={asset:`⚙`,scene:`✦`,game:`▶`};function pf(e){let t=cf[e.cat],n=document.createElement(`div`);n.className=`card down`,n.dataset.kind=e.kind,n.dataset.cat=e.cat,n.dataset.id=e.id,n.style.setProperty(`--accent`,t.color);let r=e.kind===`game`?`GODOT 4 · WEB`:`▲ ${(e.polys/1e3).toFixed(0)}K · ${e.sizeKB>1024?(e.sizeKB/1024).toFixed(1)+` MB`:e.sizeKB+` KB`}`;return n.innerHTML=`
  ...
  `,e.appendChild(r),document.body.classList.add(`deck-mode`);let i=r.querySelector(`#deckArea`),a=r.querySelector(`#deckCanvas`),o=r.querySelector(`#introLegend`),s=r.querySelector(`#rowLabels`),c=r.querySelector(`#gotIt`),l=r.querySelector(`#loading`),u=new kf(r.querySelector(`#stage`)),d=_f(r),f=Pf(r),p=df(t,n),m=p.map(e=>{let t=pf(e);return a.appendChild(t),{card:e,el:t}});mf(i);let h=!1,g=!0,_=`shuffle`,v=!1,y=()=>({x:innerWidth/2,y:innerHeight*.52}),b=()=>({x:innerWidth-96,y:innerHeight-150}),x=e=>(Math.random()-.5)*e,S=[{cats:[`assets`]},{cats:[`sim`]},{cats:[`worlds`,`game`]}],C=()=>innerWidth<700,w=()=>C()?14:26,T=()=>C()?84:100,E=()=>C()?56:64,D=()=>Math.max(64,Math.min(120,innerWidth*.08));function O(e){return e.cats.flatMap(e=>m.filter(t=>t.card.cat===e))}let k=e=>m.filter(t=>t.card.cat===e);function A(){let e=innerWidth,t=innerHeight,n=e-w()*2,r=(t-T()-28)/S.length,i=Math.min(Math.round((r-E()-10)*.72),Math.floor(Math.min(...S.map(e=>{let t=O(e).length,r=e.cats.length>1?D():0;return(n-r-(t-1)*18)/t}))),260);if(i>=104&&e>=1180){let n=Math.round(i/.72),a=new Map,o=[];return S.forEach((t,n)=>{let s=O(t),c=s.map((e,t)=>t>0&&e.card.cat===`game`&&s[t-1].card.cat!==`game`?D():0),l=s.length*i+(s.length-1)*18+c.reduce((e,t)=>e+t,0),u=(e-l)/2+i/2,d=T()+r*n+E()+(r-E())/2;s.forEach((e,t)=>{u+=c[t],a.set(e,{x:u,y:d}),u+=i+18}),t.cats.forEach(e=>{let t=s.filter(t=>t.card.cat===e);t.length&&o.push({cat:e,x:(a.get(t[0]).x+a.get(t[t.length-1]).x)/2,y:T()+r*n+E()/2})})}),{pos:a,labels:o,cw:i,ch:n,canvasH:t,scroll:!1}}let a=Math.max(2,Math.floor((n+18)/190));i=Math.floor(Math.min(210,(n-(a-1)*18)/a));let o=Math.round(i/.72),s=new Map,c=[],l=T();for(let t of[`assets`,`sim`,`worlds`,`game`]){let n=k(t);if(n.length){c.push({cat:t,x:e/2,y:l+E()/2}),l+=E();for(let t=0;t<n.length;t+=a){let r=n.slice(t,t+a),c=(e-(r.length*i+(r.length-1)*18))/2+i/2;for(let e of r)s.set(e,{x:c,y:l+o/2}),c+=i+18;l+=o+16}l+=18}}return{pos:s,labels:c,cw:i,ch:o,canvasH:Math.ceil(l+28),scroll:!0}}function ee(){let e=A();return i.style.setProperty(`--cw`,`${e.cw}px`),i.style.setProperty(`--ch`,`${e.ch}px`),i.classList.toggle(`scroll`,e.scroll),a.style.height=e.scroll?`${e.canvasH}px`:`100%`,e}function te(e=!0){_=`dealing`,i.classList.remove(`fanmode`);let t=ee();s.innerHTML=``;for(let{cat:e,x:n,y:r}of t.labels){let t=document.createElement(`div`);t.className=`rowlab`,t.style.top=`${r}px`,t.innerHTML=`<span style="--accent:${cf[e].color}">${cf[e].label}</span>`,s.appendChild(t);let i=t.offsetWidth/2;t.style.left=`${Math.min(Math.max(n,i+12),innerWidth-i-12)}px`}let n=0;for(let r of m){let i=t.pos.get(r);r.el.classList.remove(`inpile`),r.el.style.zIndex=10+n,setTimeout(()=>{hf(r.el,i.x,i.y,0),e?setTimeout(()=>r.el.classList.remove(`down`),190):r.el.classList.remove(`down`)},n*42),n++}setTimeout(()=>{h||(i.classList.add(`fanmode`),s.classList.add(`on`),_=`rows`)},m.length*42+620)}let j=ne();function ne(){let e=document.createElement(`div`);e.id=`rail`,e.classList.add(`off`),e.innerHTML=`
      <button class="rail-toggle" title="collection">⟩</button>
      <div class="rail-panel"><div class="rail-scroll"></div></div>`,r.appendChild(e);let t=e.querySelector(`.rail-scroll`);return e.querySelector(`.rail-toggle`).addEventListener(`click`,()=>{e.classList.toggle(`collapsed`)}),t.addEventListener(`click`,e=>{let t=e.target.closest(`.rail-item`);if(!t||t.classList.contains(`current`))return;let n=p.find(e=>e.id===t.dataset.id);n&&re(n)}),{el:e,show(n){let r=p.filter(e=>e.cat===n.cat&&e.kind!==`game`);t.innerHTML=r.map(e=>`
          <button class="rail-item" data-id="${e.id}" title="${e.title}" style="--accent:${cf[e.cat].color}">
            <img src="${e.thumb}" alt="${e.title}" loading="lazy" />
          </button>`).join(``),e.classList.remove(`off`),e.classList.toggle(`collapsed`,innerWidth<700),this.setCurrent(n.id)},hide(){e.classList.add(`off`)},setCurrent(e){t.querySelectorAll(`.rail-item`).forEach(t=>t.classList.toggle(`current`,t.dataset.id===e)),t.querySelector(`.rail-item[data-id="${e}"]`)?.scrollIntoView({block:`nearest`,behavior:`smooth`})}}}async function re(e){g||!v||(g=!0,await Lf(u,d,e,f)&&j.setCurrent(e.id),g=!1)}async function M(e){g=!0,e.el.querySelector(`.card-tilt`).style.transform=``,s.classList.remove(`on`),(e.card.kind===`asset`?await Ff(u,d,e.card,e.el):await If(u,d,e.card,e.el))?(v=!0,e.card,r.classList.add(`infocus`),j.show(e.card),d.dismiss.textContent=`✕`,d.dismiss.classList.add(`on`)):s.classList.add(`on`),g=!1}async function ie(e){g=!0,s.classList.remove(`on`),await zf(d,e.card,e.el),s.classList.add(`on`),g=!1}d.dismiss.addEventListener(`click`,()=>{v&&(v=!1,r.classList.remove(`infocus`),j.hide(),Rf(u,d),s.classList.add(`on`))}),i.addEventListener(`click`,e=>{if(g||v||_!==`rows`)return;let t=e.target.closest(`.card`);if(!t)return;let n=m.find(e=>e.el===t);n&&(n.card.kind===`game`?ie(n):M(n))});async function ae(e=2){let t=y(),n=Math.min(170,innerWidth*.19);i.classList.add(`fast`);for(let r=0;r<e;r++)m.forEach((e,r)=>{let i=r%2==0;setTimeout(()=>{hf(e.el,t.x+(i?-n:n)+x(18),t.y+x(14),(i?-14:14)+x(8))},r*6)}),await gf(380),m.forEach((e,n)=>{e.el.style.zIndex=n*7%m.length,setTimeout(()=>hf(e.el,t.x+x(5),t.y+x(5),x(7)),(m.length-n)*6)}),await gf(420);m.forEach((e,n)=>{setTimeout(()=>hf(e.el,t.x+x(4),t.y-46+x(6),x(5)),n*4)}),await gf(300),i.classList.remove(`fast`)}let oe=[`le-creuset-stackable-ramekins`,`shopping-mall-interior`,`dune-desert-village-v1`,`ghost-game`],se={assets:[`Articulated Assets`,`An articulated object from Blender procedural-generation agents — an actor plus critics, 1–3 h runs, 0–3 rounds of human feedback`],sim:[`Greybox Scenes`,`The same agent pipeline pushed to a whole greybox scene — 3–6 h runs, zero human feedback`],worlds:[`Generated Worlds`,`A scale-consistent world from a GenAI workflow — concept art, segmentation, mesh generation — in ~10 min, zero human feedback`],game:[`Playable Game`,`An earlier world pipeline plus vibe-coded mechanics from a Godot agent — AI-aided human creation, built in a week`]};async function ce(){_=`intro`,i.classList.add(`intromode`);let e=oe.map(e=>m.find(t=>t.card.id===e)),t=m.filter(t=>!e.includes(t)),n=b(),r=innerWidth,a=innerHeight,s=r<760,l,u,d,f;if(s){l=Math.min(150,(r-60)/2,a*.22*.72),u=Math.round(l/.72);let e=l/2+10,t=u/2+10,n=a*.24;d=i=>({x:r/2+(i%2==0?-e:e),y:n+(i<2?0:t*2)}),f={type:`single`,y:n+t*3+26}}else{let e=Math.min(r*.24,300);l=Math.min(190,e-44,a*.3*.72),u=Math.round(l/.72);let t=a*.36;d=n=>({x:r/2+(n-1.5)*e,y:t}),f={type:`columns`,spacing:e,rowY:t,ch:u}}i.style.setProperty(`--cw`,`${Math.round(l)}px`),i.style.setProperty(`--ch`,`${u}px`),o.innerHTML=``,e.forEach((e,t)=>{let n=cf[e.card.cat],[i,a]=se[e.card.cat],s=document.createElement(`div`);s.className=`leg`,f.type===`columns`?(s.style.left=`${d(t).x}px`,s.style.top=`${f.rowY+f.ch/2+22}px`,s.style.width=`${Math.min(f.spacing-18,320)}px`):(s.style.left=`${r/2}px`,s.style.top=`${f.y}px`,s.style.width=`${r-48}px`),s.innerHTML=`<div class="lt" style="color:${n.color}">${i}</div><div class="ld">${a}</div>`,o.appendChild(s)}),t.forEach((e,t)=>{e.el.classList.add(`inpile`),e.el.style.zIndex=t,setTimeout(()=>hf(e.el,n.x+x(6),n.y+x(6),x(8)),t*12)}),e.forEach((e,t)=>{e.el.style.zIndex=50+t;let n=d(t);setTimeout(()=>hf(e.el,n.x,n.y,0),250+t*140)}),await gf(1290);for(let t=0;t<e.length;t++)e[t].el.classList.remove(`down`),f.type===`single`&&t>0&&o.children[t-1].classList.remove(`on`),o.children[t].classList.add(`on`),await gf(f.type===`single`?1800:500);let p=Math.max(...[...o.children].map(e=>e.offsetHeight)),h=f.type===`columns`?f.rowY+f.ch/2+22+p+44:f.y+p+56;c.style.top=`${Math.min(h,a-72)}px`,c.classList.add(`on`),await new Promise(e=>c.addEventListener(`click`,e,{once:!0})),c.classList.remove(`on`),[...o.children].forEach(e=>e.classList.remove(`on`)),i.classList.remove(`intromode`),e.forEach(e=>e.el.classList.add(`down`)),await gf(280)}async function le(){let e=r.querySelector(`#hero`);e.classList.add(`show`),await gf(1700),!h&&(await new Promise(t=>{let n,r=()=>{clearTimeout(n),e.removeEventListener(`pointerdown`,r),removeEventListener(`wheel`,r),removeEventListener(`keydown`,r),t()};n=setTimeout(r,2e3),e.addEventListener(`pointerdown`,r),addEventListener(`wheel`,r),addEventListener(`keydown`,r)}),!h&&(e.classList.add(`out`),await gf(300),r.classList.remove(`heromode`),await gf(650),e.remove()))}async function ue(){let e=y();ee(),m.forEach((t,n)=>{t.el.classList.add(`down`),hf(t.el,e.x+x(4),e.y+x(4),x(6)),t.el.style.zIndex=n,t.el.style.transition=`none`}),i.offsetWidth,m.forEach(e=>{e.el.style.transition=``}),l.classList.add(`done`),Hf?(r.querySelector(`#hero`).remove(),await gf(450)):(await le(),Hf=!0),!h&&(await ae(2),!h&&(await gf(120),Vf||=(await ce(),!0),!h&&(te(),g=!1)))}let N=()=>{g||_!==`rows`||v||te(!1)};return addEventListener(`resize`,N),ue(),{destroy(){h=!0,removeEventListener(`resize`,N),u.dispose(),document.body.classList.remove(`deck-mode`),r.remove()}}}var Wf=document.getElementById(`app`),Gf=[],Kf=[],qf={},Jf=null,Yf=null,Xf=`./`,Zf=[[`01`,`Prompt`,`A written brief: the object or world, its parts, its purpose.`],[`02`,`Geometry`,`3D models generated per part — meshes, materials, textures.`],[`03`,`Articulation`,`Joints, hinges, sliders and kinematic chains, rigged and animated.`],[`04`,`Composition`,`Terrain, layout, placement and density composed into full scenes.`],[`05`,`Atmosphere`,`Lighting, sky, fog and post-processing tuned to the concept.`],[`06`,`Engine-ready`,`Runnable Blender and Godot files — simulation targets, not renders.`]];async function Qf(){let[e,t,n]=await Promise.all([fetch(`./data/blender.json`).then(e=>e.ok?e.json():[]),fetch(`./data/evals.json`).then(e=>e.ok?e.json():[]),fetch(`./data/concepts.json`).then(e=>e.ok?e.json():{}).catch(()=>({}))]);Gf=[...e,...t],Kf=t,qf=n,ep(),window.addEventListener(`hashchange`,ep)}var $f=[`gallery`,`play`,`objects`,`environments`,`blender-worlds`,`pipeline`];function ep(){let e=/^#\/asset\/([\w-]+)/.exec(location.hash);Jf&&=(Jf.dispose(),null),Yf&&=(Yf.destroy(),null);let t=location.hash.replace(/^#/,``);e&&Gf.some(t=>t.slug===e[1])?ip(e[1]):$f.includes(t)?(np(),t===`gallery`?window.scrollTo(0,0):document.getElementById(t)?.scrollIntoView()):tp()}function tp(){document.title=`Generated Worlds — AI 3D Content Generation`,Wf.innerHTML=``,window.scrollTo(0,0),Yf=Uf(Wf,{blender:Gf,evals:Kf})}function np(){document.title=`Generated Worlds — AI 3D Content Generation`;let e=Gf.filter(e=>e.group===`objects`),t=Gf.filter(e=>e.group===`environments`),n=Gf.filter(e=>e.group===`worlds`),r=Gf.find(e=>e.group===`objects`&&e.animated)??Gf.find(e=>e.animated)??null;Wf.innerHTML=`
    <div class="landing">
      <nav class="topnav">
