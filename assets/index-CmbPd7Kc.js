...
void main() {
	...
	`}var Bs=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ia(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`);this.workerSourceURL=URL.createObjectURL(new Blob([i]))}),this.decoderPending}_getWorker(e,t){return this._initDecoder().then(()=>{if(this.workerPool.length<this.workerLimit){let e=new Worker(this.workerSourceURL);e._callbacks={},e._taskCosts={},e._taskLoad=0,e.postMessage({type:`init`,decoderConfig:this.decoderConfig}),e.onmessage=function(t){let n=t.data;switch(n.type){case`decode`:e._callbacks[n.id].resolve(n);break;case`error`:e._callbacks[n.id].reject(n);break;default:console.error(`THREE.DRACOLoader: Unexpected message, "`+n.type+`"`)}},this.workerPool.push(e)}else this.workerPool.sort(function(e,t){return e._taskLoad>t._taskLoad?-1:1});let n=this.workerPool[this.workerPool.length-1];return n._taskCosts[e]=t,n._taskLoad+=t,n})}_releaseTask(e,t){e._taskLoad-=e._taskCosts[t],delete e._callbacks[t],delete e._taskCosts[t]}debug(){console.log(`Task load: `,this.workerPool.map(e=>e._taskLoad))}dispose(){for(let e=0;e<this.workerPool.length;++e)this.workerPool[e].terminate();return this.workerPool.length=0,this.workerSourceURL!==``&&URL.revokeObjectURL(this.workerSourceURL),this}};function tf(){let e,t;onmessage=function(r){let i=r.data;switch(i.type){case`init`:e=i.decoderConfig,t=new Promise(function(t){e.onModuleLoaded=function(e){t({draco:e})},DracoDecoderModule(e)});break;case`decode`:let r=i.buffer,a=i.taskConfig;t.then(e=>{let t=e.draco,o=new t.Decoder;try{let e=n(t,o,new Int8Array(r),a),s=e.attributes.map(e=>e.array.buffer);e.index&&s.push(e.index.array.buffer),self.postMessage({type:`decode`,id:i.id,geometry:e},s)}catch(e){console.error(e),self.postMessage({type:`error`,id:i.id,error:e.message})}finally{t.destroy(o)}});break}};function n(e,t,n,a){let o=a.attributeIDs,s=a.attributeTypes,c,l,u=t.GetEncodedGeometryType(n);if(u===e.TRIANGULAR_MESH)c=new e.Mesh,l=t.DecodeArrayToMesh(n,n.byteLength,c);else if(u===e.POINT_CLOUD)c=new e.PointCloud,l=t.DecodeArrayToPointCloud(n,n.byteLength,c);else throw Error(`THREE.DRACOLoader: Unexpected geometry type.`);if(!l.ok()||c.ptr===0)throw Error(`THREE.DRACOLoader: Decoding failed: `+l.error_msg());let d={index:null,attributes:[]};for(let n in o){let r=self[s[n]],l,u;if(a.useUniqueIDs)u=o[n],l=t.GetAttributeByUniqueId(c,u);else{if(u=t.GetAttributeId(c,e[o[n]]),u===-1)continue;l=t.GetAttribute(c,u)}let f=i(e,t,c,n,r,l);n===`color`&&(f.vertexColorSpace=a.vertexColorSpace),d.attributes.push(f)}return u===e.TRIANGULAR_MESH&&(d.index=r(e,t,c)),e.destroy(c),d}function r(e,t,n){let r=n.num_faces()*3,i=r*4,a=e._malloc(i);t.GetTrianglesUInt32Array(n,i,a);let o=new Uint32Array(e.HEAPF32.buffer,a,r).slice();return e._free(a),{array:o,itemSize:1}}function i(e,t,n,r,i,o){let s=n.num_points(),c=o.num_components(),l=a(e,i),u=c*i.BYTES_PER_ELEMENT,d=Math.ceil(u/4)*4,f=d/i.BYTES_PER_ELEMENT,p=s*u,m=s*d,h=e._malloc(p);t.GetAttributeDataArrayForAllPoints(n,o,l,p,h);let g=new i(e.HEAPF32.buffer,h,p/i.BYTES_PER_ELEMENT),_;if(u===d)_=g.slice();else{_=new i(m/i.BYTES_PER_ELEMENT);let e=0;for(let t=0,n=g.length;t<n;t++){for(let n=0;n<c;n++)_[e+n]=g[t*c+n];e+=f}}return e._free(h),{name:r,count:s,itemSize:c,array:_,stride:f}}function a(e,t){switch(t){case Float32Array:return e.DT_FLOAT32;case Int8Array:return e.DT_INT8;case Int16Array:return e.DT_INT16;case Int32Array:return e.DT_INT32;case Uint8Array:return e.DT_UINT8;case Uint16Array:return e.DT_UINT16;case Uint32Array:return e.DT_UINT32}}}var nf=class extends In{constructor(){super(),this.name=`RoomEnvironment`,this.position.y=-3.5;let e=new la;e.deleteAttribute(`uv`);let t=new ja({side:1}),n=new ja,r=new Ao(16777215,900,28,2);r.position.set(.418,16.199,.3),this.add(r);let i=new ni(e,t);i.position.set(-.757,13.219,.717),i.scale.set(31.713,28.305,28.591),this.add(i);let a=new Oi(e,n,6),o=new En;o.position.set(-10.906,2.009,1.846),o.rotation.set(0,-.195,0),o.scale.set(2.328,7.905,4.651),o.updateMatrix(),a.setMatrixAt(0,o.matrix),o.position.set(-5.607,-.754,-.758),o.rotation.set(0,.994,0),o.scale.set(1.97,1.534,3.955),o.updateMatrix(),a.setMatrixAt(1,o.matrix),o.position.set(6.167,.857,7.803),o.rotation.set(0,.561,0),o.scale.set(3.927,6.285,3.687),o.updateMatrix(),a.setMatrixAt(2,o.matrix),o.position.set(-2.017,.018,6.124),o.rotation.set(0,.333,0),o.scale.set(2.002,4.566,2.064),o.updateMatrix(),a.setMatrixAt(3,o.matrix),o.position.set(2.291,-.756,-2.621),o.rotation.set(0,-.286,0),o.scale.set(1.546,1.552,1.496),o.updateMatrix(),a.setMatrixAt(4,o.matrix),o.position.set(-2.193,-.369,-5.547),o.rotation.set(0,.516,0),o.scale.set(3.875,3.487,2.986),o.updateMatrix(),a.setMatrixAt(5,o.matrix),this.add(a);let s=new ni(e,rf(50));s.position.set(-16.116,14.37,8.208),s.scale.set(.1,2.428,2.739),this.add(s);let c=new ni(e,rf(50));c.position.set(-16.109,18.021,-8.207),c.scale.set(.1,2.425,2.751),this.add(c);let l=new ni(e,rf(17));l.position.set(14.904,12.198,-1.832),l.scale.set(.15,4.265,6.331),this.add(l);let u=new ni(e,rf(43));u.position.set(-.462,8.89,14.52),u.scale.set(4.38,5.441,.088),this.add(u);let d=new ni(e,rf(20));d.position.set(3.235,11.486,-12.541),d.scale.set(2.5,2,.1),this.add(d);let f=new ni(e,rf(100));f.position.set(0,20,0),f.scale.set(1,.1,1),this.add(f)}dispose(){let e=new Set;this.traverse(t=>{t.isMesh&&(e.add(t.geometry),e.add(t.material))});for(let t of e)t.dispose()}};function rf(e){return new Na({color:0,emissive:16777215,emissiveIntensity:e})}var af=class{constructor(e,{onReady:t,onError:n,onTime:r}={}){this.container=e,this.onReady=t??(()=>{}),this.onError=n??(()=>{}),this.onTime=r??(()=>{}),this.disposed=!1,this.playing=!0,this.duration=0,this.renderer=new wu({antialias:!0,powerPreference:`high-performance`}),this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,2)),this.renderer.toneMapping=4,this.renderer.toneMappingExposure=1.1,this.renderer.shadowMap.enabled=!0,this.renderer.shadowMap.type=2,e.appendChild(this.renderer.domElement),this.scene=new In,this.scene.background=of(),this.camera=new Eo(45,1,.05,2e3),this.controls=new Fu(this.camera,this.renderer.domElement),this.controls.enableDamping=!0,this.controls.dampingFactor=.07,this.controls.autoRotate=!0,this.controls.autoRotateSpeed=1.1,this.controls.addEventListener(`start`,()=>this.controls.autoRotate=!1);let i=new js(this.renderer);this.scene.environment=i.fromScene(new nf,.04).texture,this.scene.environmentIntensity=.85,i.dispose();let a=new No(16774374,1.6);a.castShadow=!0,a.shadow.mapSize.set(2048,2048),a.shadow.bias=-3e-4,a.shadow.normalBias=.02,this.keyLight=a,this.scene.add(a);let o=new No(12374271,.7);this.rimLight=o,this.scene.add(o);let s=new ef().setDecoderPath(`./draco/`);this.loader=new Zu().setDRACOLoader(s),this.clock=new is,this.mixer=null,this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(e),this.resize(),this.renderer.setAnimationLoop(()=>this.tick())}async load(e,{environment:t=!1,hideCeilings:n=!1,skyUrl:r=null,loopPingPong:i=!1,thumbFrame:a=0,fpCamera:o=null,lightBoost:s=1}={}){try{let c=r?new fo().loadAsync(r).catch(e=>(console.warn(`sky load failed`,e),null)):Promise.resolve(null),[l,u]=await Promise.all([this.loader.loadAsync(`./`+e),c]);if(this.disposed){u?.dispose();return}u&&(u.mapping=303,u.colorSpace=Ue,this.scene.background?.dispose?.(),this.scene.environment?.dispose?.(),this.scene.background=u,this.scene.environment=u,this.scene.environmentIntensity=1);let d=l.scene,f=[];d.traverse(e=>{e.isMesh&&(e.castShadow=!0,e.receiveShadow=!0,e.material?.map&&(e.material.map.anisotropy=8)),e.isLight&&f.push(e)}),n&&d.traverse(e=>{/(^|[\s_-])(ceil(ing)?|roof)([\s_-]|$)/i.test(e.name)&&(e.visible=!1)});let p=new Zn().setFromObject(d),m=p.getCenter(new K),h=p.getSize(new K),g=Math.max(h.x,h.y,h.z);d.position.sub(m),d.position.y+=h.y/2-(t?h.y*.06:0),this.scene.add(d),this.object=d,this.keyLight.position.set(g*1.2,g*1.8,g*1.1);let _=g*1.2;if(Object.assign(this.keyLight.shadow.camera,{left:-_,right:_,top:_,bottom:-_,near:.1,far:g*6}),this.keyLight.shadow.camera.updateProjectionMatrix(),this.rimLight.position.set(-g,g*.9,-g*1.3),f.length&&this.adoptImportedLights(f,g,!!u,s),!t){let e=new ni(new ua(g*2.4,64).rotateX(-Math.PI/2),new ba({opacity:.32}));e.receiveShadow=!0,this.scene.add(e);let t=new ni(new ua(g*2.4,64).rotateX(-Math.PI/2),new ja({color:1316383,roughness:.95,metalness:0}));t.position.y=-.002*g,t.receiveShadow=!0,this.scene.add(t)}let v=t?g*.95:g*1.55,y=t?.85:.5;if(t&&a&&(v=g*.55*a,y=.62),this.controls.target.set(0,h.y*(t?.1:.45),0),this.camera.position.set(v*.72,v*y,v*.78),this.camera.near=Math.max(.02,g/500),this.camera.far=g*30,this.camera.updateProjectionMatrix(),this.controls.minDistance=g*.25,this.controls.maxDistance=g*4.5,this.controls.maxPolarAngle=Math.PI*(t?.55:.62),this.controls.update(),t&&(this.controls.autoRotateSpeed=.5,u||(this.scene.fog=new Fn(1119002,g*2.2,g*9))),o){let e=new K(...o.position).add(d.position),t=At.degToRad(o.yaw),n=At.degToRad(o.pitch),r=new K(Math.sin(t)*Math.cos(n),Math.sin(n),-Math.cos(t)*Math.cos(n));this.camera.position.copy(e),this.controls.target.copy(e).addScaledVector(r,Math.max(g*.2,5)),this.camera.fov=o.fov,this.camera.near=Math.max(.05,g/2e3),this.camera.updateProjectionMatrix(),this.controls.autoRotate=!1,this.controls.minDistance=.1,this.controls.maxPolarAngle=Math.PI,this.controls.update()}if(l.animations.length){this.pingPong=i,this.mixer=new rs(d);for(let e of l.animations){this.duration=Math.max(this.duration,e.duration);let t=this.mixer.clipAction(e);i&&t.setLoop(Fe,1/0),t.play()}}this.onReady({animated:l.animations.length>0,duration:this.duration})}catch(e){console.error(e),this.onError(e)}}adoptImportedLights(e,t,n,r=1){let i=(n?1.8:2.2)*r,a=24*r,o=e.filter(e=>e.isDirectionalLight),s=e.filter(e=>!e.isDirectionalLight);s.sort((e,t)=>t.intensity-e.intensity);for(let e of s.slice(24))e.visible=!1;s=s.slice(0,24);let c=Math.max(...o.map(e=>e.intensity),0);if(c>i)for(let e of o)e.intensity*=i/c;let l=Math.max(...s.map(e=>e.intensity),0);if(l>a)for(let e of s)e.intensity*=a/l;for(let t of e)t.castShadow=!1;let u=o.sort((e,t)=>t.intensity-e.intensity)[0];if(u){this.keyLight.castShadow=!1,u.castShadow=!0,u.shadow.mapSize.set(2048,2048),u.shadow.bias=-3e-4,u.shadow.normalBias=.02;let e=t*1.2;Object.assign(u.shadow.camera,{left:-e,right:e,top:e,bottom:-e,near:.1,far:t*6}),u.shadow.camera.updateProjectionMatrix()}this.keyLight.intensity=(n?.35:.55)*r,this.rimLight.intensity=.2*r,this.scene.environmentIntensity=(n?.6:.5)*r}setPlaying(e){this.playing=e}seek(e){this.mixer&&this.mixer.setTime(e)}get time(){if(!this.mixer)return 0;let e=Math.max(this.duration,1e-6);if(!this.pingPong)return this.mixer.time%e;let t=this.mixer.time%(2*e);return t>e?2*e-t:t}tick(){if(this.disposed)return;let e=this.clock.getDelta();this.mixer&&this.playing&&(this.mixer.update(e),this.onTime(this.time,this.duration)),this.controls.update(),this.renderer.render(this.scene,this.camera)}resize(){let e=this.container.clientWidth||1,t=this.container.clientHeight||1;this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix()}dispose(){this.disposed=!0,this.renderer.setAnimationLoop(null),this.resizeObserver.disconnect(),this.scene.traverse(e=>{e.geometry?.dispose?.();let t=Array.isArray(e.material)?e.material:[e.material];for(let e of t)if(e){for(let t of Object.values(e))t?.isTexture&&t.dispose();e.dispose?.()}}),this.scene.background?.dispose?.(),this.scene.environment?.dispose?.(),this.renderer.dispose(),this.renderer.domElement.remove()}};function of(){let e=document.createElement(`canvas`);e.width=4,e.height=512;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,512);n.addColorStop(0,`#1b1e2b`),n.addColorStop(.55,`#12141c`),n.addColorStop(1,`#0a0b10`),t.fillStyle=n,t.fillRect(0,0,4,512);let r=new aa(e);return r.colorSpace=Ue,r}var sf=`./`,cf={assets:{label:`Articulated Assets`,short:`ASSET`,color:`#ff5c5c`,kind:`asset`},sim:{label:`Greybox Scenes`,short:`GREYBOX`,color:`#8ef0c0`,kind:`scene`},worlds:{label:`Generated Worlds`,short:`WORLD`,color:`#7c9eff`,kind:`scene`},game:{label:`Playable Game`,short:`GAME`,color:`#ffd75e`,kind:`game`}},lf=[`theme-park`,`water-park`,`theme-park-ride-system`,`supermarket-interior`,`shopping-mall-interior`,`robotic-arm-assembly-cell`,`dockyard`,`bathhouse`];function uf(e){let t=e.replace(/^Generate (a|an) /i,``).replace(/^Create a scene for [^:]*:\s*/i,``).replace(/^A /i,``);t=t.charAt(0).toUpperCase()+t.slice(1);let n=t.search(/[;.]/);return n>0&&(t=t.slice(0,n)),t.length>120&&(t=t.slice(0,117).replace(/\s+\S*$/,``)+`…`),t}function df(e,t,n={}){let r=Object.fromEntries(e.map(e=>[e.slug,e])),i=[];for(let t of e.filter(e=>e.group===`objects`))i.push({id:t.slug,cat:`assets`,kind:`asset`,title:t.title,desc:uf(t.prompt),thumb:sf+t.thumbnail,glb:sf+t.url,sky:null,concept:n[t.slug]?sf+n[t.slug]:null,animated:t.animated,loopPingPong:!!t.loopPingPong,polys:t.polys,sizeKB:t.sizeKB});for(let e of lf){let t=r[e];t&&i.push({id:e,cat:`sim`,kind:`scene`,title:t.title,desc:uf(t.prompt),thumb:sf+t.thumbnail,glb:sf+t.url,sky:t.sky?sf+t.sky:null,concept:n[e]?sf+n[e]:null,animated:t.animated,polys:t.polys,sizeKB:t.sizeKB})}for(let e of t)i.push({id:e.slug,cat:`worlds`,kind:`scene`,title:e.title,desc:uf(e.prompt),thumb:sf+e.thumbnail,glb:sf+e.url,sky:e.sky?sf+e.sky:null,lightBoost:e.lightBoost||1,concept:n[e.slug]?sf+n[e.slug]:null,animated:!1,polys:e.polys,sizeKB:e.sizeKB});return i.push({id:`ghost-game`,cat:`game`,kind:`game`,title:`Ghosts in the Dataset`,desc:`A complete cyberpunk arcade world built in Godot 4 — playable right now in your browser.`,thumb:`./play/ghost/promo/street.webp`,glb:null,sky:null,concept:null,playUrl:`./play/ghost/index.html`,animated:!1,polys:0,sizeKB:0}),i}var ff={asset:`⚙`,scene:`✦`,game:`▶`};function pf(e){let t=cf[e.cat],n=document.createElement(`div`);n.className=`card down`,n.dataset.kind=e.kind,n.dataset.cat=e.cat,n.dataset.id=e.id,n.style.setProperty(`--accent`,t.color);let r=e.kind===`game`?`GODOT 4 · WEB`:`▲ ${(e.polys/1e3).toFixed(0)}K · ${e.sizeKB>1024?(e.sizeKB/1024).toFixed(1)+` MB`:e.sizeKB+` KB`}`;return n.innerHTML=`
    ...
    <a id="fx-poster" href="${Bf}play/ghost/index.html" target="_blank" rel="noopener">
      <img src="${Bf}play/ghost/promo/street.webp" alt="Ghosts in the Dataset" />
      <div class="banner">
  ...
  `,e.appendChild(i),document.body.classList.add(`deck-mode`);let a=i.querySelector(`#deckArea`),o=i.querySelector(`#deckCanvas`),s=i.querySelector(`#introLegend`),c=i.querySelector(`#rowLabels`),l=i.querySelector(`#gotIt`),u=i.querySelector(`#loading`),d=new kf(i.querySelector(`#stage`)),f=_f(i),p=Pf(i),m=df(t,n,r),h=m.map(e=>{let t=pf(e);return o.appendChild(t),{card:e,el:t}});mf(a);let g=!1,_=!0,v=`shuffle`,y=!1,b=()=>({x:innerWidth/2,y:innerHeight*.52}),x=()=>({x:innerWidth-96,y:innerHeight-150}),S=e=>(Math.random()-.5)*e,C=[{cats:[`assets`]},{cats:[`sim`]},{cats:[`worlds`,`game`]}],w=()=>innerWidth<700,T=()=>w()?14:26,E=()=>w()?84:100,D=()=>w()?56:64,O=()=>Math.max(64,Math.min(120,innerWidth*.08));function k(e){return e.cats.flatMap(e=>h.filter(t=>t.card.cat===e))}let A=e=>h.filter(t=>t.card.cat===e);function ee(){let e=innerWidth,t=innerHeight,n=e-T()*2,r=(t-E()-28)/C.length,i=Math.min(Math.round((r-D()-10)*.72),Math.floor(Math.min(...C.map(e=>{let t=k(e).length,r=e.cats.length>1?O():0;return(n-r-(t-1)*18)/t}))),260);if(i>=104&&e>=1180){let n=Math.round(i/.72),a=new Map,o=[];return C.forEach((t,n)=>{let s=k(t),c=s.map((e,t)=>t>0&&e.card.cat===`game`&&s[t-1].card.cat!==`game`?O():0),l=s.length*i+(s.length-1)*18+c.reduce((e,t)=>e+t,0),u=(e-l)/2+i/2,d=E()+r*n+D()+(r-D())/2;s.forEach((e,t)=>{u+=c[t],a.set(e,{x:u,y:d}),u+=i+18}),t.cats.forEach(e=>{let t=s.filter(t=>t.card.cat===e);t.length&&o.push({cat:e,x:(a.get(t[0]).x+a.get(t[t.length-1]).x)/2,y:E()+r*n+D()/2})})}),{pos:a,labels:o,cw:i,ch:n,canvasH:t,scroll:!1}}let a=Math.max(2,Math.floor((n+18)/190));i=Math.floor(Math.min(210,(n-(a-1)*18)/a));let o=Math.round(i/.72),s=new Map,c=[],l=E();for(let t of[`assets`,`sim`,`worlds`,`game`]){let n=A(t);if(n.length){c.push({cat:t,x:e/2,y:l+D()/2}),l+=D();for(let t=0;t<n.length;t+=a){let r=n.slice(t,t+a),c=(e-(r.length*i+(r.length-1)*18))/2+i/2;for(let e of r)s.set(e,{x:c,y:l+o/2}),c+=i+18;l+=o+16}l+=18}}return{pos:s,labels:c,cw:i,ch:o,canvasH:Math.ceil(l+28),scroll:!0}}function te(){let e=ee();return a.style.setProperty(`--cw`,`${e.cw}px`),a.style.setProperty(`--ch`,`${e.ch}px`),a.classList.toggle(`scroll`,e.scroll),o.style.height=e.scroll?`${e.canvasH}px`:`100%`,e}function j(e=!0){v=`dealing`,a.classList.remove(`fanmode`);let t=te();c.innerHTML=``;for(let{cat:e,x:n,y:r}of t.labels){let t=document.createElement(`div`);t.className=`rowlab`,t.style.top=`${r}px`,t.innerHTML=`<span style="--accent:${cf[e].color}">${cf[e].label}</span>`,c.appendChild(t);let i=t.offsetWidth/2;t.style.left=`${Math.min(Math.max(n,i+12),innerWidth-i-12)}px`}let n=0;for(let r of h){let i=t.pos.get(r);r.el.classList.remove(`inpile`),r.el.style.zIndex=10+n,setTimeout(()=>{hf(r.el,i.x,i.y,0),e?setTimeout(()=>r.el.classList.remove(`down`),190):r.el.classList.remove(`down`)},n*42),n++}setTimeout(()=>{g||(a.classList.add(`fanmode`),c.classList.add(`on`),v=`rows`)},h.length*42+620)}let ne=re();function re(){let e=document.createElement(`div`);e.id=`rail`,e.classList.add(`off`),e.innerHTML=`
      <button class="rail-toggle" title="collection">⟩</button>
      <div class="rail-panel"><div class="rail-scroll"></div></div>`,i.appendChild(e);let t=e.querySelector(`.rail-scroll`);return e.querySelector(`.rail-toggle`).addEventListener(`click`,()=>{e.classList.toggle(`collapsed`)}),t.addEventListener(`click`,e=>{let t=e.target.closest(`.rail-item`);if(!t||t.classList.contains(`current`))return;let n=m.find(e=>e.id===t.dataset.id);n&&M(n)}),{el:e,show(n){let r=m.filter(e=>e.cat===n.cat&&e.kind!==`game`);t.innerHTML=r.map(e=>`
          <button class="rail-item" data-id="${e.id}" title="${e.title}" style="--accent:${cf[e.cat].color}">
            <img src="${e.thumb}" alt="${e.title}" loading="lazy" />
          </button>`).join(``),e.classList.remove(`off`),e.classList.toggle(`collapsed`,innerWidth<700),this.setCurrent(n.id)},hide(){e.classList.add(`off`)},setCurrent(e){t.querySelectorAll(`.rail-item`).forEach(t=>t.classList.toggle(`current`,t.dataset.id===e)),t.querySelector(`.rail-item[data-id="${e}"]`)?.scrollIntoView({block:`nearest`,behavior:`smooth`})}}}async function M(e){_||!y||(_=!0,await Lf(d,f,e,p)&&ne.setCurrent(e.id),_=!1)}async function ie(e){_=!0,e.el.querySelector(`.card-tilt`).style.transform=``,c.classList.remove(`on`),(e.card.kind===`asset`?await Ff(d,f,e.card,e.el):await If(d,f,e.card,e.el))?(y=!0,e.card,i.classList.add(`infocus`),ne.show(e.card),f.dismiss.textContent=`← Back`,f.dismiss.classList.add(`on`)):c.classList.add(`on`),_=!1}async function ae(e){_=!0,c.classList.remove(`on`),await zf(f,e.card,e.el),c.classList.add(`on`),_=!1}f.concept.querySelector(`img`).addEventListener(`click`,()=>{f.lightbox.querySelector(`img`).src=f.concept.querySelector(`img`).src,f.lightbox.classList.add(`on`)}),f.lightbox.addEventListener(`click`,()=>f.lightbox.classList.remove(`on`)),f.dismiss.addEventListener(`click`,()=>{y&&(y=!1,i.classList.remove(`infocus`),ne.hide(),Rf(d,f),c.classList.add(`on`))}),a.addEventListener(`click`,e=>{if(_||y||v!==`rows`)return;let t=e.target.closest(`.card`);if(!t)return;let n=h.find(e=>e.el===t);n&&(n.card.kind===`game`?ae(n):ie(n))});let oe=[`le-creuset-stackable-ramekins`,`dishwasher`,`office-chair`,`shopping-mall-interior`,`theme-park`,`dune-desert-village-v1`,`elden-ring-castle-v2`,`japanese-shrine-night-v2`,`ghost-game`],N=(e,t)=>e+Math.random()*(t-e);function se(){let e=new Set(oe.map(e=>h.find(t=>t.card.id===e)).filter(Boolean));for(let t of[`assets`,`sim`,`worlds`,`game`]){let n=t===`game`?1:2;for(let r of A(t)){if([...e].filter(e=>e.card.cat===t).length>=n)break;e.add(r)}}return e}function ce(){let e=b(),t=innerWidth,n=innerHeight,r=se();a.classList.add(`flying`);let i=parseFloat(a.style.getPropertyValue(`--cw`))||164,s=Math.min(1,t*.1/i),c=h.map((e,t)=>t*7%h.length),l=h.map((i,a)=>{let o=r.has(i),l=!o&&a%3==1,u=`LRTRLB`[a%6],d=140+Math.random()*220,f=u===`L`?{x:-d,y:n*N(.05,.95)}:u===`R`?{x:t+d,y:n*N(.05,.95)}:u===`T`?{x:t*N(.08,.92),y:-d}:{x:t*N(.08,.92),y:n+d},p=a*2.39996+N(-.25,.25),m=l?{x:f.x<t/2?t*N(.62,.9):t*N(.1,.38),y:n*N(.22,.78)}:{x:t*.5+Math.cos(p)*t*(o?N(.13,.3):N(.12,.4)),y:n*.48+Math.sin(p)*n*(o?N(.11,.26):N(.1,.36))},h=m.x-f.x,g=m.y-f.y,_=N(.2,l?.6:.45)*(a%2?1:-1),v={x:(f.x+m.x)/2-g*_,y:(f.y+m.y)/2+h*_},y=2e3+c[a]*26,b=(o?N(.35,.7):N(.5,1))*(Math.random()<.5?-1:1),x=N(o?.75:.5,1)*(Math.random()<.5?-1:1),C=N(.1,.35)*(Math.random()<.5?-1:1),w=Math.hypot(b,x,C),T=(o?N(1.7,2.4):l?N(4.2,6):N(2.6,4))*360/y*(a%3==0?-1:1),E=y*.72,D=(o?180+S(50):N(-130,130))-T*E,O=o?N(-40,200):l?N(40,150):N(-460,120),k=l?Math.min(600-O,N(300,520)):0;return{en:i,up:o,crosser:l,start:f,ctrl:v,drift:m,shineEl:i.el.querySelector(`.shine`),axis:`${(b/w).toFixed(3)}, ${(x/w).toFixed(3)}, ${(C/w).toFixed(3)}`,w:T,a0:D,z0:O,zPeak:k,s0:s*(o?N(1.05,1.55):l?N(.85,1.1):N(.55,1.05)),s1:s*(o?N(.95,1.15):N(.75,1)),rot0:N(-26,26),spin:N(12,34)*(a%2?1:-1),grabAt:y,end:{x:e.x+S(4),y:e.y-46+S(6),rot:S(5)},zEnd:40+c[a],grab:null,done:!1,x:0,y:0,rot:0,sc:1,z:0,a:0}}),u=e=>`translate3d(${e.x.toFixed(1)}px, ${e.y.toFixed(1)}px, 0px) rotate(${e.rot.toFixed(2)}deg) scale(${e.sc.toFixed(3)}) perspective(1100px) translateZ(${e.z.toFixed(1)}px) rotate3d(${e.axis}, ${e.a.toFixed(2)}deg)`;for(let e of l)e.en.el.classList.add(`down`),e.en.el.style.zIndex=5+Math.round(e.s0*20),e.x=e.start.x,e.y=e.start.y,e.z=e.z0,e.rot=e.rot0,e.sc=e.s0,e.a=e.a0,e.en.el.style.transform=u(e);async function d(){let e=e=>1-(1-e)**2.4,t=e=>1-(1-e)**1.6,n=e=>e**1.9,r=Math.PI/180;await new Promise(i=>{let a=l.length,o=performance.now(),s=c=>{if(g){i();return}let d=c-o,f=d/1e3;for(let i of l){if(i.done)continue;let o=1;if(d<i.grabAt){let n=(i.crosser?t:e)(Math.min(1,d/i.grabAt)),r=1-n;i.x=r*r*i.start.x+2*r*n*i.ctrl.x+n*n*i.drift.x,i.y=r*r*i.start.y+2*r*n*i.ctrl.y+n*n*i.drift.y,i.rot=i.rot0+i.spin*f,i.sc=i.s0+(i.s1-i.s0)*n,i.a=i.a0+i.w*d,i.z=i.z0+i.zPeak*Math.sin(Math.PI*n)}else{i.grab||(i.grab={x:i.x,y:i.y,rot:i.rot,sc:i.sc,z:i.z,a:i.a,aEnd:Math.round(i.a/360)*360},i.en.el.style.zIndex=i.zEnd);let e=Math.min(1,(d-i.grabAt)/480),t=n(e);i.x=i.grab.x+(i.end.x-i.grab.x)*t,i.y=i.grab.y+(i.end.y-i.grab.y)*t,i.rot=i.grab.rot+(i.end.rot-i.grab.rot)*t,i.sc=i.grab.sc+(1-i.grab.sc)*t,i.a=i.grab.a+(i.grab.aEnd-i.grab.a)*t,i.z=i.grab.z*(1-t),o=1-t,e>=1&&(i.done=!0,a--)}let s=Math.abs(Math.sin(i.a*r))**5*.9*o;i.shineEl.style.opacity=s>.04?s.toFixed(2):`0`,i.done?(hf(i.en.el,i.end.x,i.end.y,i.end.rot),i.shineEl.style.opacity=``):i.en.el.style.transform=u(i)}a>0?requestAnimationFrame(s):i()};requestAnimationFrame(s)}),a.classList.remove(`flying`),!g&&(o.classList.add(`thump`),setTimeout(()=>o.classList.remove(`thump`),400))}return{run:d}}let le=[`le-creuset-stackable-ramekins`,`shopping-mall-interior`,`dune-desert-village-v1`,`ghost-game`],P={assets:[`Articulated Assets`,`An articulated object from Blender procedural-generation agents — an actor plus critics, 1–3 h runs, 0–3 rounds of human feedback`],sim:[`Greybox Scenes`,`The same agent pipeline pushed to a whole greybox scene — 3–6 h runs, zero human feedback`],worlds:[`Generated Worlds`,`A scale-consistent world from a GenAI workflow — concept art, segmentation, mesh generation — in ~10 min, zero human feedback`],game:[`Playable Game`,`An earlier world pipeline plus vibe-coded mechanics from a Godot agent — AI-aided human creation, built in a week`]};async function ue(){v=`intro`,a.classList.add(`intromode`);let e=le.map(e=>h.find(t=>t.card.id===e)),t=h.filter(t=>!e.includes(t)),n=x(),r=innerWidth,i=innerHeight,o=r<760,c,u,d,f;if(o){c=Math.min(150,(r-60)/2,i*.22*.72),u=Math.round(c/.72);let e=c/2+10,t=u/2+10,n=i*.24;d=i=>({x:r/2+(i%2==0?-e:e),y:n+(i<2?0:t*2)}),f={type:`single`,y:n+t*3+26}}else{let e=Math.min(r*.24,300);c=Math.min(190,e-44,i*.3*.72),u=Math.round(c/.72);let t=i*.36;d=n=>({x:r/2+(n-1.5)*e,y:t}),f={type:`columns`,spacing:e,rowY:t,ch:u}}a.style.setProperty(`--cw`,`${Math.round(c)}px`),a.style.setProperty(`--ch`,`${u}px`),s.innerHTML=``,e.forEach((e,t)=>{let n=cf[e.card.cat],[i,a]=P[e.card.cat],o=document.createElement(`div`);o.className=`leg`,f.type===`columns`?(o.style.left=`${d(t).x}px`,o.style.top=`${f.rowY+f.ch/2+22}px`,o.style.width=`${Math.min(f.spacing-18,320)}px`):(o.style.left=`${r/2}px`,o.style.top=`${f.y}px`,o.style.width=`${r-48}px`),o.innerHTML=`<div class="lt" style="color:${n.color}">${i}</div><div class="ld">${a}</div>`,s.appendChild(o)}),t.forEach((e,t)=>{e.el.classList.add(`inpile`),e.el.style.zIndex=t,setTimeout(()=>hf(e.el,n.x+S(6),n.y+S(6),S(8)),t*12)}),e.forEach((e,t)=>{e.el.style.zIndex=50+t;let n=d(t);setTimeout(()=>hf(e.el,n.x,n.y,0),250+t*140)}),await gf(1290);for(let t=0;t<e.length;t++)e[t].el.classList.remove(`down`),f.type===`single`&&t>0&&s.children[t-1].classList.remove(`on`),s.children[t].classList.add(`on`),await gf(f.type===`single`?1800:500);let p=Math.max(...[...s.children].map(e=>e.offsetHeight)),m=f.type===`columns`?f.rowY+f.ch/2+22+p+44:f.y+p+56;l.style.top=`${Math.min(m,i-72)}px`,l.classList.add(`on`),await new Promise(e=>l.addEventListener(`click`,e,{once:!0})),l.classList.remove(`on`),[...s.children].forEach(e=>e.classList.remove(`on`)),a.classList.remove(`intromode`),e.forEach(e=>e.el.classList.add(`down`)),await gf(280)}async function de(){let e=i.querySelector(`#hero`);e.classList.add(`show`),await gf(1700),!g&&(await new Promise(t=>{let n,r=()=>{clearTimeout(n),e.removeEventListener(`pointerdown`,r),removeEventListener(`wheel`,r),removeEventListener(`keydown`,r),t()};n=setTimeout(r,2e3),e.addEventListener(`pointerdown`,r),addEventListener(`wheel`,r),addEventListener(`keydown`,r)}),!g&&(e.classList.add(`out`),await gf(300),i.classList.remove(`heromode`),await gf(650),e.remove()))}async function fe(){te();let e=ce();u.classList.add(`done`),Hf?(i.querySelector(`#hero`).remove(),await gf(450)):(await de(),Hf=!0),!g&&(await e.run(),!g&&(await gf(120),Vf||=(await ue(),!0),!g&&(j(),_=!1)))}let pe=()=>{_||v!==`rows`||y||j(!1)};return addEventListener(`resize`,pe),fe(),{destroy(){g=!0,removeEventListener(`resize`,pe),d.dispose(),document.body.classList.remove(`deck-mode`),i.remove()}}}var Wf=document.getElementById(`app`),Gf=[],Kf=[],qf={},Jf=null,Yf=null,Xf=`./`,Zf=[[`01`,`Prompt`,`A written brief: the object or world, its parts, its purpose.`],[`02`,`Geometry`,`3D models generated per part — meshes, materials, textures.`],[`03`,`Articulation`,`Joints, hinges, sliders and kinematic chains, rigged and animated.`],[`04`,`Composition`,`Terrain, layout, placement and density composed into full scenes.`],[`05`,`Atmosphere`,`Lighting, sky, fog and post-processing tuned to the concept.`],[`06`,`Engine-ready`,`Runnable Blender and Godot files — simulation targets, not renders.`]];async function Qf(){let[e,t,n]=await Promise.all([fetch(`./data/blender.json`).then(e=>e.ok?e.json():[]),fetch(`./data/evals.json`).then(e=>e.ok?e.json():[]),fetch(`./data/concepts.json`).then(e=>e.ok?e.json():{}).catch(()=>({}))]);Gf=[...e,...t],Kf=t,qf=n,ep(),window.addEventListener(`hashchange`,ep)}var $f=[`gallery`,`play`,`objects`,`environments`,`blender-worlds`,`pipeline`];function ep(){let e=/^#\/asset\/([\w-]+)/.exec(location.hash);Jf&&=(Jf.dispose(),null),Yf&&=(Yf.destroy(),null);let t=location.hash.replace(/^#/,``);e&&Gf.some(t=>t.slug===e[1])?ip(e[1]):$f.includes(t)?(np(),t===`gallery`?window.scrollTo(0,0):document.getElementById(t)?.scrollIntoView()):tp()}function tp(){document.title=`Generated Worlds — AI 3D Content Generation`,Wf.innerHTML=``,window.scrollTo(0,0),Yf=Uf(Wf,{blender:Gf,evals:Kf,concepts:qf})}function np(){document.title=`Generated Worlds — AI 3D Content Generation`;let e=Gf.filter(e=>e.group===`objects`),t=Gf.filter(e=>e.group===`environments`),n=Gf.filter(e=>e.group===`worlds`),r=Gf.find(e=>e.group===`objects`&&e.animated)??Gf.find(e=>e.animated)??null;Wf.innerHTML=`
    <div class="landing">
      <nav class="topnav">
      ...
      <section class="collection" id="play">
        ...
        <div class="playable-wrap">
          <a class="playable-banner" href="${Xf}play/ghost/index.html" target="_blank" rel="noopener">
            <img class="playable-shot" src="${Xf}play/ghost/promo/street.webp" alt="Ghosts in the Dataset — cyberpunk street" loading="lazy" />
          ...
          <div class="playable-side">
            <img src="${Xf}play/ghost/promo/title.webp" alt="Ghosts in the Dataset title screen" loading="lazy" />
  ...
  `,r&&(Jf=new af(document.getElementById(`hero-canvas`),{}),Jf.load(r.url,{loopPingPong:!!r.loopPingPong}))}function rp(e){let t=e.prompt?cp(e.prompt):``;return`
    <a class="card card-asset" href="#/asset/${e.slug}">
      <img class="thumb" src="${Xf}${e.thumbnail}" alt="${cp(e.title)}" loading="lazy"
  ...
  `}function ip(e){let t=Gf.find(t=>t.slug===e),n=Gf.filter(e=>e.group===t.group),r=n.indexOf(t),i=n[(r-1+n.length)%n.length],a=n[(r+1)%n.length],o=t.group===`environments`||t.group===`worlds`,s=qf[t.slug]?Xf+qf[t.slug]:null;document.title=`${t.title} — Generated Worlds`,Wf.innerHTML=`
    <div class="viewer">
        ...
        <div class="hud-bottom hud-bottom-asset">
          <div class="hud-left-stack">
            ...
            <div class="concept-panel">
              ...
              <img class="concept-thumb" src="${s}" alt="Concept art for ${cp(t.title)}" title="click to enlarge" />
            </div>`:``}
            ${t.prompt?`
  ...
  `;let c=Wf.querySelector(`.viewer-canvas`),l=Wf.querySelector(`.loader`),u=Wf.querySelector(`.anim-controls`),d=Wf.querySelector(`.play-btn`),f=Wf.querySelector(`.scrub`),p=Wf.querySelector(`.anim-time`),m=!1;Jf=new af(c,{onReady:({animated:e,duration:t})=>{l.classList.add(`done`),window.__SCENE_READY=!0,e&&t>.5&&(u.hidden=!1)},onError:()=>{l.innerHTML=`<div class="viewer-error">Failed to load this asset.<br/><a href="#/" style="color:var(--accent)">back to gallery</a></div>`},onTime:(e,t)=>{m||(f.value=String(Math.round(e/Math.max(t,1e-6)*1e3)),p.textContent=e.toFixed(1)+`s`)}}),window.__SCENE_READY=!1,window.__VIEWER=Jf;let h=new URLSearchParams(location.search),g=h.get(`thumb`),_=h.get(`fp`),v=o&&_?op(_):null;Jf.load(t.url,{environment:o,hideCeilings:!v&&(t.collection===`interiors`||t.collection===`scenes`),skyUrl:t.sky?Xf+t.sky:null,loopPingPong:!!t.loopPingPong,thumbFrame:o&&g?parseFloat(g)||1:0,fpCamera:v,lightBoost:t.lightBoost||1}),d.addEventListener(`click`,()=>{Jf.setPlaying(!Jf.playing),d.textContent=Jf.playing?`❚❚`:`▶`}),f.addEventListener(`pointerdown`,()=>m=!0),f.addEventListener(`pointerup`,()=>m=!1),f.addEventListener(`input`,()=>{let e=Number(f.value)/1e3*Jf.duration;Jf.seek(e),p.textContent=e.toFixed(1)+`s`});let y=Wf.querySelector(`.concept-thumb`);y&&y.addEventListener(`click`,()=>ap(s,t.title))}function ap(e,t){let n=document.createElement(`div`);n.className=`concept-lightbox`,n.innerHTML=`
    <img src="${e}" alt="Concept art for ${cp(t)}" />
    <div class="concept-lightbox-caption">CONCEPT REFERENCE — ${cp(t.toUpperCase())} · CLICK OR ESC TO CLOSE</div>
  `;let r=()=>{n.remove(),document.removeEventListener(`keydown`,i)},i=e=>{e.key===`Escape`&&r()};n.addEventListener(`click`,r),document.addEventListener(`keydown`,i),document.body.appendChild(n)}function op(e){let t=e.split(`,`).map(Number);if(t.length<3||!t.slice(0,3).every(Number.isFinite))return null;let[n,r,i,a=0,o=0,s=62]=t;return{position:[n,r,i],yaw:a||0,pitch:o||0,fov:s||62}}function sp(e){return e>=1e6?(e/1e6).toFixed(1)+`M`:e>=1e3?(e/1e3).toFixed(0)+`K`:String(e)}function cp(e){return e.replace(/[&<>"']/g,e=>({"&":`&amp;`,"<":`&lt;`,">":`&gt;`,'"':`&quot;`,"'":`&#39;`})[e])}Qf();